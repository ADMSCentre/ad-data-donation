...
export const PrimaryButton = ({ label, spinning = false, enabled = true, color = 'bg-primary border-primary text-text', onClick }: Weak<PropsUIButtonPrimary>): JSX.Element => {
  return (
    <div className='relative min-w-button'>
      <div className={`flex flex-col items-center leading-none font-button text-button rounded ${enabled ? 'cursor-pointer active:shadow bg-opacity-50 border transition-all hover:bg-opacity-100' : ''} ${color}`} onClick={onClick}>
